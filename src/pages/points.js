    ...
    <>
      ...
      <Row>
        <Col className="square1">
          ...
          <img
            ...
            src={Jeffrey}
            alt="profile-icon"
            style={{ height: 80, width: 80, marginLeft: 62, marginTop: -20 }}
          />
        ...
        <Col md={{ offset: 1 }} className="square2">
          ...
          <img
            className="profile-img"
            src={"https://ca.slack-edge.com/E88MEPKJQ-W012N34V0H1-d2192c665cea-512"}
            alt="profile-icon"
            style={{ height: 80, width: 80, marginLeft: 62, marginTop: -20 }}
          />
        ...
        <Col md={{ offset: 1}} className="square3">
          ...
          <img
            ...
            src={"https://ca.slack-edge.com/E88MEPKJQ-W013RRHEGGY-0bef0be9c1b3-72"}
            alt="profile-icon"
            style={{ height: 80, width: 80, marginLeft: 62, marginTop: -20 }}
          />
      ...
      <Col className="square4" style={{marginTop: 50}}>
       ...
       <img
            ...
            src={"https://ca.slack-edge.com/E88MEPKJQ-W0132R4EGRH-4913c4847b42-512"}
            alt="profile-icon"
      ...
      <Col className="square4"style={{marginTop: 10}}>
       ...
       <img
            className="profile-img2"
            src={"https://ca.slack-edge.com/E88MEPKJQ-W9C8NU2BC-c96992158088-512"}
            alt="profile-icon"
            style={{ height: 30, width: 30}}
          />
      ...
      <Col className="square4"style={{marginTop: 10}}>
       ...
       <img
            className="profile-img2"
            src={"https://ca.slack-edge.com/E88MEPKJQ-W012SAYD17W-9a2c058efc21-512"}
            alt="profile-icon"
            style={{ height: 30, width: 30}}
          />
      ...
      <Col className="square4"style={{marginTop: 10}}>
       ...
       <img
            className="profile-img2"
            src={"https://ca.slack-edge.com/E88MEPKJQ-W013L2KRK3J-21cc73605b06-512"}
            alt="profile-icon"
            style={{ height: 30, width: 30}}
          />
      ...
      <Col className="square4"style={{marginTop: 10}}>
       ...
       <img
            className="profile-img2"
            src={"https://ca.slack-edge.com/E88MEPKJQ-W012AA7RDPG-b8e065232a1f-512"}
            alt="profile-icon"
            style={{ height: 30, width: 30}}
          />
